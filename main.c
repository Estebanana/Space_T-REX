...
struct textures_s{
    ...
    SDL_Texture* sprite; /*!< Textures utiles au programme. */
};
...
struct world_s{
    int jposx; /*!< Champ indiquant la position horizontale du joueur. */
    int jposy; /*!< Champ indiquant la position verticale du joueur. */
...
void init_data(world_t * world){
    ...
    world->gameover = 0;
    world->jposx = (SCREEN_WIDTH - SPRITE_SIZE)/2;
    world->jposy = (SCREEN_HEIGHT - SPRITE_SIZE)/2;
}
...
void refresh_graphics(SDL_Renderer *renderer, world_t *world,textures_t *textures){
    ...
    apply_texture(textures->sprite,renderer, world->jposx, world->jposy);
